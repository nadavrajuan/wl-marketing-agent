...
const FUNNEL_COLORS: Record<string, string> = {
  quiz_start: "bg-indigo-900 text-indigo-300",
  quiz_complete: "bg-purple-900 text-purple-300",
  add_to_cart: "bg-yellow-900 text-yellow-300",
  purchase: "bg-emerald-900 text-emerald-300",
  purchase_reversal: "bg-rose-900 text-rose-300",
    ...
    <div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 mb-5 flex flex-wrap gap-3">
        {[
          ...
          { key: "funnel_step", label: "Funnel", opts: [["quiz_start","Quiz Start"],["quiz_complete","Quiz Complete"],["add_to_cart","Add to Cart"],["purchase","Purchase"],["purchase_reversal","Purchase Reversal"],["lead","Lead"]] },
        ...
        <div className="flex items-center gap-2 mt-4">
          ...
          <button
            onClick={() => {
              ...
              fetch_data(Math.min(totalPages, page + 1));
            }}
